...
<form action="#" class="form-horizontal">
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Form Dasar</h5>
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" class="form-control" placeholder="Agung Justika">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="password" class="form-control" placeholder="Ketik Password Anda">
                </div>
            </div>

            <div class="form-group">
                <label class="col-lg-3 control-label">Tempat Tinggal:</label>
                <div class="col-lg-9">
                    <select class="select">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label">Avatar Anda:</label>
                <div class="col-lg-9">
                    <input type="file" class="file-styled">
                    <span class="help-block">Formats yang diterima: gif, png, jpg. Maximal ukuran 2Mb</span>
                </div>
            </div>

            <div class="form-group">
                <label class="col-lg-3 control-label">Pesan Anda:</label>
                <div class="col-lg-9">
                    <textarea rows="5" cols="5" class="form-control" placeholder="Tulis pesan Anda Disini"></textarea>
                </div>
            </div>
...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title">Validasi</h6>
        <div class="heading-elements">
            <ul class="icons-list">
                <li><a data-action="collapse"></a></li>
                <li><a data-action="reload"></a></li>
